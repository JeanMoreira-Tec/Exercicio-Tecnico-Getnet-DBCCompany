...
public class GerenciarUsuario {
	...
	public void getBuscaUsuarioErro() {
		...
		Response response = RestAssured.get(url);		
		Assert.assertEquals(response.getStatusCode(), 404, "Status Code Esperado");
